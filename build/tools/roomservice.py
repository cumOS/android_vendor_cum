...
custom_local_manifest = ".repo/local_manifests/cum.xml"
custom_default_revision =  os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'tiramisu')
custom_dependencies = "cum.dependencies"
org_manifest = "cum-devices"  # leave empty if org is provided in manifest
org_display = "CumOS-Devices"  # needed for displaying
