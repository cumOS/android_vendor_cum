...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/cum/fonts/prebuilt,$(TARGET_COPY_OUT_PRODUCT)/fonts) \
    vendor/cum/fonts/fonts_customization.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/fonts_customization.xml